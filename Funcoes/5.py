...
inteiros. Deve haver pelo menos duas funções: uma para fazer a conversão e uma para a saída. 
...
um loop que permita que o usuário repita esse cálculo para novos valores de entrada todas as 
vezes que desejar.'''
